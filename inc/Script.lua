...
redis:set(matrex.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(matrex..'lock:join:'..msg.chat_id_,true)
...
redis:del(matrex..'lock:join:'..msg.chat_id_)
return "*✦ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n✦ ** تم فتح الدخول بالرابط \n*" 
end


local function imatrex(msg,MsgText)

Channel = redis:get(matrex..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(matrex..'joinchnl') then
...
redis:setex(matrex..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(matrex..'CheckExpire::'..msg.chat_id_) then 
redis:set(matrex..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(matrex..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(matrex..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(matrex..'CheckExpire::'..msg.chat_id_) then 
redis:set(matrex..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(matrex..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(matrex..'CheckExpire::'..msg.chat_id_) then 
redis:set(matrex..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(matrex..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(matrex..'CheckExpire::'..msg.chat_id_) then 
redis:set(matrex..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(matrex..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(matrex..'group:name'..msg.chat_id_) or '')
redis:set(matrex..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(matrex..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. matrex..'')
...
if not msg.Director and redis:get(matrex..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(matrex..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(matrex..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(matrex..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(matrex..'admins:'..msg.chat_id_)
redis:del(matrex..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(matrex..'owners:'..msg.chat_id_)
redis:del(matrex..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(matrex..'whitelist:'..msg.chat_id_)
redis:del(matrex..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(matrex..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(matrex..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(matrex..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(matrex..'linkGroup'..msg.sender_user_id_,300,true)
return '✦ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(matrex..'linkGroup'..msg.chat_id_) then 
return "✦ ** اوه لا يوجد رابط .\n✦ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(matrex..'group:name'..msg.chat_id_)
local GroupLink = redis:get(matrex..'linkGroup'..msg.chat_id_)
...
local Text = "✦ رابـط الـمـجـمـوعه ✦ \n"..Flter_Markdown(redis:get(matrex..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(matrex..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(matrex..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "✦ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(matrex..':Filter_Word:'..msg.chat_id_)
...
redis:del(matrex..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(matrex..'welcome:msg'..msg.chat_id_) then 
return "✦ ** اوه هنالك خطأ .\n✦ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(matrex..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(matrex..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "✦ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(matrex..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "✦ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(matrex..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "✦ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(matrex..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(matrex..'banned:'..msg.chat_id_)
if #list == 0 then return "*✦ لا يوجد مستخدمين محظورين  *" end
message = '✦ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(matrex..'banned:'..msg.chat_id_)
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."   \n✦  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(matrex..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "✦ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(matrex..'is_silent_users:'..msg.chat_id_)
...
redis:del(matrex..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "✦ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(matrex..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(matrex..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "✦ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(matrex..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(matrex..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(matrex..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(matrex..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(matrex..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(matrex..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(matrex..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(matrex..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(matrex..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(matrex..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(matrex.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'✦-ɴᴀᴍᴇ :  ۦ'..Namei..'    \n✦-ụѕᴇʀ : ۦ'..UserNameID..' .\n✦-ᴍѕɢᴇ⁞  : ۦ'..msgs..' .\n✦-ѕᴛᴀ : ۦ '..msg.TheRank..' .\n✦-ɪᴅ  ۦ'..msg.sender_user_id_..' .\n✦-ᴄʜ ✦ : ۦ @SourceMaTreX .\n▁',dl_cb,nil)
		else
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(matrex..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(matrex..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(matrex..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(matrex..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(matrex..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(matrex..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(matrex..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(matrex..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(matrex..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(matrex..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "✦ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '✦ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(matrex..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(matrex..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "✦ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(matrex..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(matrex..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "✦ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(matrex..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
.."[✦](https://t.me/SourceMaTreX) ~~~~~~~~~~~~~~~~~~[✦](https://t.me/SourceMaTreX) \n"
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(matrex..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(matrex..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(matrex..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(matrex..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(matrex..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(matrex..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(matrex..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(matrex..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(matrex..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(matrex..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(matrex..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(matrex..'welcome:msg'..msg.chat_id_))
else 
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."  \n✦ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(matrex..'group:ids')
...
local pv = redis:smembers(matrex..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(matrex..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(matrex..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[✦ اهلا انا بوت]]..redis:get(matrex..':NameBot:')..[[ .
...
redis:setex(matrex..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '✦ حسننا عزيزي .\n✦ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(matrex..':addnumberusers',MsgText[2]) 
return '✦ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'✦ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(matrex..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "✦ **هذا الامر يخص {المطور} فقط  \n" end
return '✦ ** عدد المجموعات المفعلة » `'..redis:scard(matrex..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "✦ **هذا الامر يخص {المطور} فقط  \n" end
return '✦ **عدد المشتركين في البوت : `'..redis:scard(matrex..'users')..'` \n'
end
...
if not msg.SudoUser then return "✦ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(matrex..'group:ids',MsgText[2]) then
local name_gp = redis:get(matrex..'group:name'..MsgText[2])
...
return redis:get(matrex..":TEXT_SUDO") or '✦ لا توجد كليشه المطور .\n✦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"✦ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(matrex..'lock_brod') then 
return "✦ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(matrex..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(matrex..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(matrex..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(matrex..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(matrex..'welcom:witting'..msg.sender_user_id_,
matrex..'rulse:witting'..msg.sender_user_id_,
matrex..'rulse:witting'..msg.sender_user_id_,
matrex..'name:witting'..msg.sender_user_id_,
matrex..'about:witting'..msg.sender_user_id_,
matrex..'fwd:all'..msg.sender_user_id_,
matrex..'fwd:pv'..msg.sender_user_id_,
matrex..'fwd:groups'..msg.sender_user_id_,
matrex..'namebot:witting'..msg.sender_user_id_,
matrex..'addrd_all:'..msg.sender_user_id_,
matrex..'delrd:'..msg.sender_user_id_,
matrex..'addrd:'..msg.sender_user_id_,
matrex..'delrdall:'..msg.sender_user_id_,
matrex..'text_sudo:witting'..msg.sender_user_id_,
matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_,
matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(matrex..":VERSION",GetVerison)
return false
else
...
return '✦ اصدار سورس ماتريكس : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'✦ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ماتريكس يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SourceMaTreX"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : ماتريكس](https://t.me/SourceMaTreX)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المبرمج جاك" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://t.me/V_P_E"}}}
send_key(msg.sender_user_id_,'   [المبرمج جاك](https://t.me/V_P_E)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المبرمج جاك واتساب" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://wa.me/+201010543299?text="}}}
send_key(msg.sender_user_id_,'   [المبرمج جاك واتساب](https://wa.me/+201010543299?text=)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المطور الجوكر" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://t.me/A_j_o_k_e_r"}}}
send_key(msg.sender_user_id_,'   [المطور الجوكر](https://t.me/A_j_o_k_e_r)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "JOCK" and msg.type == "pv" then
local inline = {{{text="جوك السورس اضـغـط هـنـآ ",url="https://t.me/JOKN1"}}}
send_key(msg.sender_user_id_,'   [المالك جوك](https://t.me/JOKN1)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "ELTURKEYY" and msg.type == "pv" then
local inline = {{{text="التركي السورس اضـغـط هـنـآ ",url="https://t.me/HH22H"}}}
send_key(msg.sender_user_id_,'   [المالك التركي](https://t.me/HH22H)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '✦ الاحصائيات . \n\n✦ **عدد المجموعات المفعله : '..redis:scard(matrex..'group:ids')..'\n✦ **عدد المشتركين في البوت : '..redis:scard(matrex..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(matrex..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(matrex..'replay:'..msg.chat_id_)
local photo 	= redis:exists(matrex..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(matrex..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(matrex..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(matrex..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(matrex..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(matrex..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(matrex..'replay:'..msg.chat_id_,matrex..'replay_photo:group:'..msg.chat_id_,matrex..'replay_voice:group:'..msg.chat_id_,
matrex..'replay_animation:group:'..msg.chat_id_,matrex..'replay_audio:group:'..msg.chat_id_,matrex..'replay_sticker:group:'..msg.chat_id_,matrex..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(matrex..'replay:all')
local photo 	= redis:exists(matrex..'replay_photo:group:')
local voice 	= redis:exists(matrex..'replay_voice:group:')
local imation 	= redis:exists(matrex..'replay_animation:group:')
local audio 	= redis:exists(matrex..'replay_audio:group:')
local sticker 	= redis:exists(matrex..'replay_sticker:group:')
local video 	= redis:exists(matrex..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(matrex..'replay:all',matrex..'replay_photo:group:',matrex..'replay_voice:group:',matrex..'replay_animation:group:',matrex..'replay_audio:group:',matrex..'replay_sticker:group:',matrex..'replay_video:group:')
...
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(matrex..'delrdall:'..msg.sender_user_id_,true) 
return "✦ حسننا عزيزي  .\n✦ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(matrex..'delrd:'..msg.sender_user_id_,true)
return "✦ حسننا عزيزي  .\n✦ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "✦ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(matrex..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(matrex..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(matrex..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(matrex..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(matrex..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(matrex..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(matrex..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(matrex..'replay:all')
local photo 	= redis:hkeys(matrex..'replay_photo:group:')
local voice 	= redis:hkeys(matrex..'replay_voice:group:')
local imation 	= redis:hkeys(matrex..'replay_animation:group:')
local audio 	= redis:hkeys(matrex..'replay_audio:group:')
local sticker 	= redis:hkeys(matrex..'replay_sticker:group:')
local video 	= redis:hkeys(matrex..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '✦ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "✦ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(matrex..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "✦ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(matrex..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✦ " end
if not redis:get(matrex..'lave_me'..msg.chat_id_) then 
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."\n✦ ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(matrex..'lave_me'..msg.chat_id_) 
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."\n✦ ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "✦ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✦ " end
if redis:get(matrex..'lave_me'..msg.chat_id_) then 
return "✦ **أهلا عزيزي "..msg.TheRankCmd.."\n✦ ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(matrex..'lave_me'..msg.chat_id_,true)  
...
[✦](https://t.me/SourceMaTreX) ~~~~~~~~~~~~~~~~~~[✦](https://t.me/SourceMaTreX) 
[SOURCE MaTreX..🖤](https://t.me/SourceMaTreX) 
✦[~~~~~~~~~~~~~~~~~~](https://t.me/SourceMaTreX)✦
[𖤍 DEV 𖤍 Elturkeyy](https://t.me/HH22H) 
[𖤍 DEV 𖤍 Jok](https://t.me/JOKN1) 
[✦](https://t.me/SourceMaTreX)~~~~~~~~~~~~~~~~~~[✦](https://t.me/SourceMaTreX) 
[SOURCE CH💚](https://t.me/SourceMaTreX) 
✦[~🖤~~~~~~~~~~~~~🖤~](https://t.me/SourceMaTreX)✦
...
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(matrex..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"✦ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(matrex..":UserNameChaneel")
if UserChaneel then
...
if redis:get(matrex..'welc'..msg.chat_id_) == 'on' then
...
local hash = matrex..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(matrex..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(matrex..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(matrex..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'✦ اهلا عزيزي \n✦ تم تثبيت الامر الجديد\n✓')
redis:del(matrex..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "✦ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(matrex..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(matrex..'CmD:'..msg.chat_id_,cmd)
redis:srem(matrex..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"✦ اهلا عزيزي\nالامر >"..cmd.."\n✦ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "✦ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(matrex..'CmD:'..msg.chat_id_)
redis:del(matrex..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"✦ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "✦ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(matrex..'CmDlist:'..msg.chat_id_)
local t = '✦ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(matrex..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(matrex..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(matrex..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(matrex..'welc'..msg.chat_id_,'off')
redis:del(matrex..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,matrex)   
if matrex.content_.ID == "MessageSticker" then        
local bd = matrex.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(matrex..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(matrex..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*✦ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(matrex..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس ماتريكس\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
{"المبرمج جاك واتساب","المبرمج جاك"},
{"المطور الجوكر"},
{"JOCK","ELTURKEYY"},
{"مصنع بوتات المبرمج"},
...
redis:sadd(matrex..'users',msg.sender_user_id_)
if redis:get(matrex..'lock_service') then 
text = [[✦ أهلاً انا بوت   []]..redis:get(matrex..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(matrex.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(matrex..'lock_twasel') then
...
redis:setex(matrex.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(matrex..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(matrex..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(matrex..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n✦ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(matrex..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه صوره للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(matrex..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه بصمه صوت للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(matrex..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه متحركه للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(matrex..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه فيديو للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(matrex..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه للصوت للرد بنجاح\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(matrex..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(matrex..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(matrex..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(matrex..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✦ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(matrex..'replay_photo:group:',klma,photo_id)
redis:del(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه صوره للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(matrex..'replay_voice:group:',klma,voice_id)
redis:del(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه بصمه صوت للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(matrex..'replay_animation:group:',klma,animation_id)
redis:del(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه متحركه للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(matrex..'replay_video:group:',klma,video_id)
redis:del(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه فيديو للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(matrex..'replay_audio:group:',klma,audio_id)
redis:del(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم اضافه للصوت للرد العام\n✦ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(matrex..'replay_sticker:group:',klma,sticker_id)
redis:del(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(matrex..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(matrex..":ForceSub:"..msg.sender_user_id_)
...
redis:set(matrex..":UserNameChaneel",msg.text)
...
if redis:get(matrex..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(matrex..'namebot:witting'..msg.sender_user_id_)
redis:set(matrex..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"✦ تم تغير اسم البوت  .\n✦ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(matrex..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(matrex..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(matrex..'replay_photo:group:',msg.text)
redis:hdel(matrex..'replay_voice:group:',msg.text)
redis:hdel(matrex..'replay_animation:group:',msg.text)
redis:hdel(matrex..'replay_audio:group:',msg.text)
redis:hdel(matrex..'replay_sticker:group:',msg.text)
redis:hdel(matrex..'replay_video:group:',msg.text)
redis:setex(matrex..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✦ جيد , يمكنك الان ارسال جوا ب الردالعام \n✦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(matrex..'delrdall:'..msg.sender_user_id_) then
redis:del(matrex..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(matrex..'replay:all',msg.text)
local photo =redis:hget(matrex..'replay_photo:group:',msg.text)
local voice = redis:hget(matrex..'replay_voice:group:',msg.text)
local animation = redis:hget(matrex..'replay_animation:group:',msg.text)
local audio = redis:hget(matrex..'replay_audio:group:',msg.text)
local sticker = redis:hget(matrex..'replay_sticker:group:',msg.text)
local video = redis:hget(matrex..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'✦ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(matrex..'replay:all',msg.text)
redis:hdel(matrex..'replay_photo:group:',msg.text)
redis:hdel(matrex..'replay_voice:group:',msg.text)
redis:hdel(matrex..'replay_audio:group:',msg.text)
redis:hdel(matrex..'replay_animation:group:',msg.text)
...
if redis:get(matrex..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(matrex..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(matrex..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "✦ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(matrex..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(matrex..'welcom:witting'..msg.sender_user_id_) 
redis:set(matrex..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✦ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(matrex..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(matrex..'rulse:witting'..msg.sender_user_id_) 
redis:set(matrex..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'✦ ** مرحبآ عزيزي\n✦ تم حفظ القوانين بنجاح .\n✦ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(matrex..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(matrex..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(matrex..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(matrex..'linkGroup'..msg.sender_user_id_,link) 
redis:set(matrex..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'✦ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(matrex..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(matrex..'about:witting'..msg.sender_user_id_) 
...
if redis:get(matrex..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(matrex..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(matrex..'users')  
local groups = redis:smembers(matrex..'group:ids')
...
if redis:get(matrex..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(matrex..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(matrex..'users')
if #pv >= 300 then
...
if redis:get(matrex..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(matrex..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(matrex..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(matrex..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(matrex..':WELCOME_BOT'),[[✦أهلاً انا بوت ]]..redis:get(matrex..':NameBot:')..[[
✦ أختصاصي حماية‌‏ المجموعات
✦ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(matrex..'fwd:'..msg.sender_user_id_) then
redis:del(matrex..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(matrex..'users')
local groups = redis:smembers(matrex..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(matrex..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(matrex..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(matrex..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'✦ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(matrex..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(matrex..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(matrex..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(matrex..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(matrex..'replay:'..msg.chat_id_,msg.text)
redis:hdel(matrex..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(matrex..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(matrex..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(matrex..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(matrex..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(matrex..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(matrex..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✦ جيد , يمكنك الان ارسال جواب الرد \n✦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(matrex..'delrd:'..msg.sender_user_id_) then
redis:del(matrex..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(matrex..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(matrex..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(matrex..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(matrex..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(matrex..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(matrex..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(matrex..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'✦ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(matrex..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(matrex..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(matrex..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(matrex..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(matrex..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(matrex..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(matrex..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(matrex..'welcome:msg'..msg.chat_id_) or "✦ اهلاً عزيزي {الاسم}\n✦ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n✦ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(matrex..'rulse:msg'..msg.chat_id_) or "✦ مرحباً عزيري القوانين كلاتي .\n✦ ممنوع نشر الروابط\n✦ ممنوع التكلم او نشر صور اباحيه\n✦ ممنوع  اعاده توجيه\n✦ ممنوع التكلم بالسياسة\n✦ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(matrex..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(matrex..'welcome:msg'..msg.chat_id_) or "✦ اهلن بك عزيزي {الاسم}\n✦ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n✦ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(matrex..'rulse:msg'..msg.chat_id_) or "✦ مرحباً عزيري القوانين كلاتي .\n✦ ممنوع نشر الروابط\n✦ ممنوع التكلم او نشر صور اباحيه\n✦ ممنوع  اعاده توجيه\n✦ ممنوع التكلم بالسياسة\n✦ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(matrex..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(matrex..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(matrex..'welcome:get'..msg.chat_id_)
end
redis:setex(matrex..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(matrex..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(matrex..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_matrex = (redis:get(matrex..'num_msg_matrex'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_matrex) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(matrex..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"✦ العضو » "..USERNAME.."\n✦ قمـت بتكرار اكثر مـن "..NUM_MSG_matrex.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(matrex..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(matrex..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(matrex..'lock_woring'..msg.chat_id_) and not redis:get(matrex..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(matrex..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(matrex..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(matrex..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'✦ ** لا يمكنني مسح الرساله المخالفه .\n✦ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(matrex..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(matrex..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(matrex..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(matrex..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(matrex..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(matrex..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(matrex..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(matrex..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(matrex..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(matrex..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(matrex..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(matrex..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(matrex..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(matrex..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(matrex..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(matrex..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(matrex..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(matrex..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(matrex..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(matrex..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(matrex..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(matrex..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(matrex..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(matrex..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(matrex..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(matrex..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(matrex..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(matrex..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(matrex..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(matrex..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(matrex..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(matrex..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(matrex..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(matrex..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(matrex..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(matrex..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(matrex..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(matrex..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(matrex..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(matrex..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(matrex..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(matrex..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
sendMsg(msg.chat_id_,msg.id_,nnn[math.random(#nnn)]) 
  elseif Text== "جاك" or Text== "المبرمج" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد من القمدان يبرو](https://t.me/V_P_E)")
  elseif Text== "JOCK" or Text== "جوك " then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس ماتريكس ](https://t.me/JOKN1)")
  elseif Text== "التركي" or Text== "تركي " then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس ماتريكس ](https://t.me/HH22H)")
  elseif Text== "الجوكر" or Text== "جوكر " then return  sendMsg(msg.chat_id_,msg.id_,"[عم التيلي ياهه ❅](https://t.me/A_j_o_k_e_r)")
...
return sendMsg(msg.chat_id_,msg.id_,"[ مطور البوت](https://t.me/SourceMaTreX) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[ منشئ المجمواع](https://t.me/SourceMaTreX)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[ مدير المجموعه ](https://t.me/SourceMaTreX)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[ ادمن ](https://t.me/SourceMaTreX)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[ عضو](https://t.me/SourceMaTreX)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انتا مرحب بيك يا مطور](https://t.me/SourceMaTreX) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[ منشئ المجموعه](https://t.me/SourceMaTreX)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[ دخلت عبر الرابط](https://t.me/SourceMaTreX)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[ دخلت عبر الرابط](https://t.me/SourceMaTreX)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[ دخلت عبر الرابط](https://t.me/SourceMaTreX)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..matrex..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(matrex..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(matrex..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(matrex..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(matrex..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(matrex..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(matrex..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(matrex..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(matrex..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(matrex..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'✦ انتهى الاشتراك في احد المجموعات .\n✦ المجموعه : '..FlterName(redis:get(matrex..'group:name'..msg.chat_id_))..'.\n✦ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'✦ انتهى الاشتراك البوت.\n✦ سوف اغادر المجموعه فرصه سعيده .\n✦ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(matrex..'ExpireDate:'..msg.chat_id_) / 86400)
