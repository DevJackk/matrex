...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(matrex..":NameBot:")
...
var =  'الجوكر ياهه'
elseif redis:sismember(matrex..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(matrex..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(matrex..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(matrex..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(matrex..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(matrex..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(matrex..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(matrex..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(matrex..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(matrex..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(matrex..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(matrex..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(matrex..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(matrex..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(matrex..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(matrex..':SUDO_BOT:')
message = '⋆ ** قائمه الـمـطـوريـن : \n\n`⋆ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(matrex..'username:'..v)
local count = redis:scard(matrex..'mtwr_count'..v)
...
local monsha = redis:smembers(matrex..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⋆ قائمه المدراء :*\n\n'
local list = redis:smembers(matrex..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(matrex..'admins:'..msg.chat_id_)
...
local list = redis:smembers(matrex..'whitelist:'..msg.chat_id_)
...
if redis:sismember(matrex..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(matrex..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(matrex..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(matrex..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(matrex..'gban_users')
...
local list = redis:smembers(matrex..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(matrex..':Filter_Word:'..msg.chat_id_,word) then 
return  "⋆ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(matrex..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(matrex..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(matrex..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(matrex..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(matrex..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(matrex..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(matrex..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(matrex..'group:ids')
message = '⋆ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(matrex..'group:name'..v)
if info then 
...
redis:del(
matrex..'group:add'..id_group,
matrex..'lock_link'..id_group, 
matrex..'lock_id'..id_group,
matrex..'lock_spam'..id_group, 
matrex..'lock_webpage'..id_group,
matrex..'lock_markdown'..id_group,
matrex..'lock_flood'..id_group,
matrex..'lock_bots'..id_group,
matrex..'mute_forward'..id_group,
matrex..'mute_contact'..id_group,
matrex..'mute_location'..id_group,
matrex..'mute_document'..id_group,
matrex..'mute_keyboard'..id_group,
matrex..'mute_game'..id_group,
matrex..'mute_inline'..id_group,
matrex..'lock_username'..id_group,
matrex..'num_msg_matrex'..id_group,
matrex..'replay'..id_group
)
redis:srem(matrex..'group:ids',id_group)
end
...
redis:hset(matrex..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(matrex..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(matrex..'group:add'..msg.chat_id_) then  return '⋆ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(matrex..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(matrex..':addnumberusers') or 0)
...
local lock_service = redis:get(matrex..'lock_service')
if lock_service then 
sendMsg(msg.chat_id_,msg.id_,'⋆*تم تفعيل المجموعه . \n*⋆ ورفع كل المشرفين\n [SOURCE MaTreX..🖤](t.me/SourceMaTreX)')
else
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(matrex..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(matrex..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
matrex..'group:add'..msg.chat_id_,true,
matrex..'lock_link'..msg.chat_id_,true, 
matrex..'lock_id'..msg.chat_id_,true,
matrex..'lock_spam'..msg.chat_id_,true,
matrex..'lock_webpage'..msg.chat_id_,true,
matrex..'lock_markdown'..msg.chat_id_,true,
matrex..'lock_flood'..msg.chat_id_,true,
matrex..'lock_bots'..msg.chat_id_,true,
matrex..'mute_forward'..msg.chat_id_,true,
matrex..'mute_contact'..msg.chat_id_,true,
matrex..'mute_location'..msg.chat_id_,true,
matrex..'mute_document'..msg.chat_id_,true,
matrex..'mute_keyboard'..msg.chat_id_,true,
matrex..'mute_game'..msg.chat_id_,true,
matrex..'mute_inline'..msg.chat_id_,true,
matrex..'lock_username'..msg.chat_id_,true,
matrex..'num_msg_matrex'..msg.chat_id_,5, 
matrex..'replay'..msg.chat_id_,true
)

redis:sadd(matrex..'group:ids',msg.chat_id_) 
redis:sadd(matrex..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(matrex..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(matrex..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(matrex..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(matrex..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(matrex..'username:'..UserID,'username',Resolv)
redis:sadd(matrex..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(matrex..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(matrex..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(matrex..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(matrex..'username:'..UserID,'username',Resolv)
redis:sadd(matrex..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(matrex..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(matrex..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(matrex..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(matrex..'username:'..UserID, 'username', Resolv)
redis:sadd(matrex..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(matrex..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(matrex..'whitelist:'..ChatID,UserID)
...
if redis:sismember(matrex..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(matrex..'username:'..UserID, 'username', Resolv)
redis:sadd(matrex..'owners:'..ChatID,UserID)
...
if redis:sismember(matrex..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(matrex..'username:'..UserID, 'username', Resolv)
redis:sadd(matrex..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(matrex..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(matrex..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(matrex..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(matrex..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(matrex..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(matrex..'username:'..UserID, 'username', Resolv)
redis:sadd(matrex..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(matrex..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(matrex..'banned:'..ChatID,UserID)
...
if redis:sismember(matrex..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(matrex..'username:'..UserID, 'username', Resolv)
redis:sadd(matrex..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(matrex..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(matrex..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(matrex..'username:'..UserID, 'username',Resolv)
redis:sadd(matrex..'gban_users',UserID)
...
redis:srem(matrex..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره العام \n',17,USERCAR) 
end
...
elseif UserID == 1019610884 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد مالك السورس\n") 
elseif UserID == 1038368606 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد مالك السورس\n") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك كتم البابا جاك\n") 
...
if redis:sismember(matrex..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(matrex..'username:'..UserID, 'username', Resolv)
redis:sadd(matrex..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(matrex..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(matrex..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(matrex..'username:'..UserID, 'username', UserName)
redis:sadd(matrex..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(matrex..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⋆ **العضو » ❪ '..UserName..' ❫\n⋆ **الايدي » ❪ `'..UserID..'` ❫\n⋆ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(matrex..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(matrex..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(matrex..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(matrex..'username:'..UserID, 'username', Resolv)
redis:sadd(matrex..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(matrex..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(matrex..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⋆ **العضو » '..USERNAME..' \n⋆ ** الايدي » (`'..UserID..'`)\n⋆ **انه بالتأكيد ليس مطور \n') end
redis:srem(matrex..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(matrex..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(matrex..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(matrex..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(matrex..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⋆*` اعدادات المجموعه :` \n"
.."\n⋆ التعديل «» "..(redis:get(matrex..'lock_edit'..msg.chat_id_) or 'false')
.."\n⋆ الروابط «» "..(redis:get(matrex..'lock_link'..msg.chat_id_) or 'false')
.."\n⋆ التاك «» "..(redis:get(matrex..'lock_tag'..msg.chat_id_) or 'false')
.."\n⋆ المعرفات «» "..(redis:get(matrex..'lock_username'..msg.chat_id_) or 'false')
.."\n⋆ التكرار «» "..(redis:get(matrex..'lock_flood'..msg.chat_id_) or 'false')
.."\n⋆ الكلايش «» "..(redis:get(matrex..'lock_spam'..msg.chat_id_) or 'false')
.."\n⋆ الويب «» "..(redis:get(matrex..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⋆ الماركدوان «» "..(redis:get(matrex..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⋆ بالطرد البوتات «» "..(redis:get(matrex..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⋆ البوتات «» "..(redis:get(matrex..'lock_bots'..msg.chat_id_) or 'false')
.."\n⋆ عدد التكرار «» "..(redis:get(matrex..'num_msg_matrex'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⋆`اعدادات الوسائط :`\n"
.."\n*⋆ *المتحركه «» "..(redis:get(matrex..'mute_gif'..msg.chat_id_) or 'false')
.."\n⋆ الدردشه «» "..(redis:get(matrex..'mute_text'..msg.chat_id_) or 'false')
.."\n⋆ الانلاين «» "..(redis:get(matrex..'mute_inline'..msg.chat_id_) or 'false')
.."\n⋆ الالعاب «» "..(redis:get(matrex..'mute_game'..msg.chat_id_) or 'false')
.."\n⋆ الصور «» "..(redis:get(matrex..'mute_photo'..msg.chat_id_) or 'false')
.."\n⋆ الفيديو «» "..(redis:get(matrex..'mute_video'..msg.chat_id_) or 'false')
.."\n⋆ البصمات «» "..(redis:get(matrex..'mute_audio'..msg.chat_id_) or 'false')
.."\n⋆ الصوت «» "..(redis:get(matrex..'mute_voice'..msg.chat_id_) or 'false')
.."\n⋆ الملصقات «» "..(redis:get(matrex..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⋆ الجهات «» "..(redis:get(matrex..'mute_contact'..msg.chat_id_) or 'false')
.."\n⋆ التوجيه «» "..(redis:get(matrex..'mute_forward'..msg.chat_id_) or 'false')
.."\n⋆ الموقع «» "..(redis:get(matrex..'mute_location'..msg.chat_id_) or 'false')
.."\n⋆ الملفات «» "..(redis:get(matrex..'mute_document'..msg.chat_id_) or 'false')
.."\n⋆ الاشعارات «» "..(redis:get(matrex..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⋆ الكيبورد «» "..(redis:get(matrex..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*`اعدادات اخرى : `"
.."\n\n*⋆*الترحيب «» "..welcomex
.."\n*⋆*الردود «» "..replayx
...
.."\n*⋆*الويب «» "..(redis:get(matrex..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⋆*الماركدوان «» "..(redis:get(matrex..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات بالطرد «» "..(redis:get(matrex..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات «» "..(redis:get(matrex..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⋆*عدد التكرار «» "..(redis:get(matrex..'num_msg_matrex'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*اعدادات التقـييد :\n"
.."\n*⋆*التقييد بالتوجيه «» "..(redis:get(matrex..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالصور «» "..(redis:get(matrex..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالروابط «» "..(redis:get(matrex..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالمتحركه «» "..(redis:get(matrex..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد الفيديو «» "..(redis:get(matrex..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
